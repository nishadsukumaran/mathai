-- ============================================================
-- MathAI — Full Schema Migration
-- Generated from database/schema/schema.prisma
...
-- ─── NEXTAUTH TABLES (required by @next-auth/prisma-adapter) ─
...
-- Link NextAuth accounts/sessions to users
...
CREATE TABLE "topic_progress" (
  ...
  "updatedAt"         TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "topic_progress_userId_topicId_key" UNIQUE ("userId", "topicId"),
...
CREATE TABLE "student_badges" (
  ...
  CONSTRAINT "student_badges_userId_badgeId_key" UNIQUE ("userId", "badgeId"),
...
CREATE TABLE "student_quest_progress" (
  ...
  "createdAt"     TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "student_quest_progress_userId_questId_expiresAt_key" UNIQUE ("userId", "questId", "expiresAt"),
...
-- Lets Prisma track migration state if you switch to migrate later

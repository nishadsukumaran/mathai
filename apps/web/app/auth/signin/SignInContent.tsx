 ...
 *
 * Client component that reads ?callbackUrl= and ?error= from the URL and
 * renders the sign-in UI. Must be wrapped in <Suspense> by its parent page
 * so that Next.js can statically pre-render the page shell without executing

...
/**
 * @module apps/web/app/progress/ProgressView
 *
 * Presentation layer for the student progress page.
...
interface StrandData {
  ...
  topics: Array<{ id: string; name: string; isUnlocked: boolean; grade: string; masteryLevel?: string }>;
}
...
function masteryLevelFromPct(pct: number): "not_started" | "emerging" | "developing" | "mastered" | "extended" {
              ...
              <div key={strand.strand.id} className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {strand.topics.map((topic) => (
                    ...
                    >
                      <MasteryRing
                        level={(topic.masteryLevel as any) ?? "not_started"}
                        size={36}
                      >
